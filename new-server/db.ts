  ...
  messages.splice(0, Infinity, ...[
    {
      ...
      createdAt: new Date(new Date('1-1-2019 GMT').getTime() - 60 * 1000 * 1000),
      sender: '1',
      recipient: '2',
    },
    {
      id: '2',
      content: "Hey, it's me",
      createdAt: new Date(new Date('1-1-2019 GMT+08:00').getTime() - 2 * 60 * 1000 * 1000),
      sender: '1',
      recipient: '3',
    },
    {
      ...
      createdAt: new Date(new Date('1-1-2019 GMT+08:00').getTime() - 24 * 60 * 1000 * 1000),
      sender: '1',
      recipient: '4',
    },
    {
      ...
      createdAt: new Date(new Date('1-1-2019 GMT-08:00').getTime() - 14 * 24 * 60 * 1000 * 1000),
      sender: '1',
      recipient: '5',
    },
  ])
